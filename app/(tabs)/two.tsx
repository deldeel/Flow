...
const styles = StyleSheet.create({
  ...
  groupTitle: { color: '#777', fontWeight: '800', fontSize: 22 },
  groupRight: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  groupTotal: { color: '#B0B0B0', fontWeight: '900', fontSize: 22 },
  chevWrap: { width: 22, alignItems: 'center', justifyContent: 'center' },
  ...
  itemSub: { marginTop: 5, fontSize: 13, color: '#8D8D93', fontWeight: '600' },
  itemAmount: { position: 'absolute', right: 16, top: 18, fontSize: 18, fontWeight: '900' },
